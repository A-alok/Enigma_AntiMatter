...
class HospitalReportProcessor:
    ...
    def generate_patient_profile(self, aggregated_data: Dict) -> Dict[str, any]:
        """Generate patient profile for disease prediction"""
        profile = {}
        
        # Map aggregated data to model features
        feature_mapping = {
